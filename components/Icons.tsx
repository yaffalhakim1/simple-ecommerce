...
export const CartIcon = memo(IconCart);

const IconBxMenuAltRight = (props: React.SVGProps<SVGSVGElement>) => {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="currentColor"
...
export const MenuIcon = memo(IconBxMenuAltRight);
...
export const GithubIcon = memo(IconGithub);
